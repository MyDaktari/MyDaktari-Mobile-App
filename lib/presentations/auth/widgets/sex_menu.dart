...
class SexMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AuthPageProvider authPageProvider = context.read<AuthPageProvider>();
    return InkWell(
      onTapDown: (TapDownDetails details) => showMenu<Sex>(
          ...
          items: Sex.values
              .map((sex) => PopupMenuItem<Sex>(
                  onTap: () {
                    authPageProvider.updateSex(sex);
                  },
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              if (authPageProvider.sex != null)
                Text(
                  authPageProvider.sex?.name ?? '',
